...
public class CommonConstants {
    ...
    public static final int FLAG_GET_ADD_PERSONER_EVENT_SUCCESS = 13;
    public static final int FLAG_GET_ADD_PERSONER_EVENT_FAIL = 14;
    /**
     * yaozhongping
     * 从100开始
     */
	public static final int FLAG_GET_SEARCH_RESULT_SHOW = 102;
	public static final int FLAG_GET_FRIEND_LIST_SHOW = 103;
