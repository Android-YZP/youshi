...
public class AddGroupChatActivity extends Activity {
        ...
        mBtnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name == null || name.equals("")) {
                    Toast.makeText(AddGroupChatActivity.this, "您未填写昵称", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(AddGroupChatActivity activity) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (flag) {
                case 0:
                    ...
                    ((AddGroupChatActivity) mActivity.get()).showTip(errorMsg);
                    break;
                case CommonConstants.FLAG_CHANGE_NICKNAME_SUCCESS:
                    //修改成功
                    ((AddGroupChatActivity) mActivity.get()).updateUserInfo();
                    break;
                case CommonConstants.FLAG_CHANGE_ERROR1:
                    //认证错误
                    String errorMsg1 = ("认证错误");
                    ((AddGroupChatActivity) mActivity.get()).showTip(errorMsg1);
                    break;
                case CommonConstants.FLAG_CHANGE_ERROR3:
                    //请求失败
                    String errorMsg3 = ("请求失败");
                    ((AddGroupChatActivity) mActivity.get()).showTip(errorMsg3);
                    break;
                default:
                    break;
            }
    ...
    public void updateUserInfo() {
        ...
        CommonUtil.saveUserInfo(mUser, AddGroupChatActivity.this);
    ...
    private void ChangeNickNameFromNet() {
        //弹出加载进度条
        mProgressDialog = ProgressDialog.show(AddGroupChatActivity.this, "请稍等", "正在修改中...", true, true);
        //使用xutils3访问网络并获取返回值
        RequestParams requestParams = new RequestParams(CommonConstants.ChangeNickName);
        //包装请求参数
        String code = CommonUtil.getUserInfo(AddGroupChatActivity.this).getLoginCode();
        name = mEtName.getText().toString();
